...
export default function Home() {
    ...
    return (
        <div className="flex flex-row h-screen bg-gradient-to-r from-gray-100 via-blue-50 to-gray-100">
            <div className="max-w-60 border-r shadow-lg bg-white">
        ...
        <div className="w-full h-screen flex p-6">
            <div className="space-y-4 animate-pulse w-full">
                <div className="flex items-center w-full space-x-4">
                    <div className="shadow-md rounded-lg h-44 bg-blue-100 w-full"></div>
                    <div className="shadow-md rounded-lg h-44 bg-blue-200 w-full"></div>
                    <div className="shadow-md rounded-lg h-44 bg-blue-300 w-full"></div>
                    <div className="shadow-md rounded-lg h-44 bg-blue-400 w-full"></div>
                </div>
